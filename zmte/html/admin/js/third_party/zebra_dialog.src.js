        ...
        plugin.init = function() {
            ...
            if (plugin.settings.source && typeof plugin.settings.source == 'object') {
                    ...
                    switch (type) {
                        ...
                        case 'ajax':
                            ...
                            var
                                ...
                                preloader = jQuery('<div>').attr('class', 'ZebraDialog_loading').appendTo(canvas);
                        ...
                        case 'iframe':
                            ...
                            plugin.message.addClass('ZebraDialog_Preloader');
			    ...
			    // create the iFrame and place it inside the dialog box
                            canvas.append(jQuery('<iframe>').attr(iframe_options).load(function() {
				plugin.message.removeClass('ZebraDialog_Preloader');
				}));
