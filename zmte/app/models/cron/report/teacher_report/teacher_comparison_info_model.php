 ...
 * @final 2015-11-17
 */
class Teacher_comparison_info_model extends CI_Model 
{
    private static $_db;
	 ...
	 * @param number $teacher_id 班级ID
	 */
	public function module_knowledge($rule_id = 0, $exam_id = 0, $teacher_id = 0)
	{
	 ...
	 * @param number $teacher_id 班级ID
	 */
	public function module_group_type($rule_id = 0, $exam_id = 0, $teacher_id = 0)
	{
	    $rule_id = intval($rule_id);
	    $exam_id = intval($exam_id);
	    $teacher_id = intval($teacher_id);
	 ...
	 * @param number $teacher_id 班级ID
	 */
	public function module_method_tactic($rule_id = 0, $exam_id = 0, $teacher_id = 0)
	{
		$rule_id = intval($rule_id);
		$exam_id = intval($exam_id);
		$teacher_id = intval($teacher_id);
