...
if (!function_exists('get_http_host')) {
    ...
    {
        $server_name = isset($_SERVER['HTTP_X_FORWARDED_HOST']) ? $_SERVER['HTTP_X_FORWARDED_HOST'] : $_SERVER['HTTP_HOST'];
        return $server_name;
    }
}
...
/** 获取服务端口 */
if (!function_exists('get_server_port')) {
...
if (!function_exists('get_server_addr')) {
    ...
    {
        $server_addr = isset($_SERVER['HTTP_X_FORWARDED_FOR']) ? $_SERVER['HTTP_X_FORWARDED_FOR'] : $_SERVER['REMOTE_ADDR'];
        return $server_addr;
    }
}
