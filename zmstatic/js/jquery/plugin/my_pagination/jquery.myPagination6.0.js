...
(function($) {
    function init(param, obj) {
        ...
        function onRequest() {
        	var error = opts.ajax.error || function () {alert("\u8bbf\u95ee\u670d\u52a1\u5668\u8d85\u65f6\uff0c\u8bf7\u91cd\u8bd5\uff0c\u8c22\u8c22\uff01")};
            debug(opts.id), debug("ajax\u8bf7\u6c42\u53c2\u6570\u5217\u8868:"), debug(getParam()), opts.ajax.on ? (opts.ajax.ajaxStart(), $.ajax({url: opts.ajax.url,type: opts.ajax.type,data: getParam(),contentType: "application/x-www-form-urlencoded;utf-8",async: !0,cache: !1,timeout: opts.timeout,error: error, success: function(a) {
            ...
            switch (opts.ajax.dataType) {
                case "json":
                    try {
                        ...
                        resultPageCount = eval("data." + pageCountId) || eval("data.data." + pageCountId);
                    }
                    break;
                case "xml":
                    try {
        ...
        var defaults = {currPage: 1,pageCount: 10,pageNumber: 5,cssStyle: "badoo",debug: !1,ajax: {on: !1,type: "POST",pageCountId: "pageCount",url: "jsonTest.php",dataType: "json",param: !1, error: !1, timeout: 6e4, onClick: function() {
                    return !1
                },ajaxStart: function() {
                    return !1
                },ajaxStop: function() {
        ...
        }, method.resetAjaxParams = function(a) {
        	a && a instanceof Object && (opts.ajax.param = $.extend({}, opts.ajax.param, a));
        }, method.getAjaxParams = function() {
